...
namespace LabCamaronWeb.Servicios.Comercial.Servicios
{
    internal class SePlanificacionSiembraService(IConfiguration configuration, IOperacionHttpServicio operacionHttp) : ISePlanificacionSiembraService
    {
        ...
        public async Task<RespuestaConsultaGenericaVm<PlanificacionSiembraVm>> ConsultarPorId(PlanificacionSiembraVm.ConsultarPlanificacionSiembraId consultar)
        {
            try
            {
                var respuesta = await _operacionHttp
                    .EjecutarServicioAutenticado<PlanificacionSiembraVm.ConsultarPlanificacionSiembraId, RespuestaConsultaGenericaVm<PlanificacionSiembraVm>>(
        ...
        public async Task<RespuestaConsultasGenericaVm<PlanificacionSiembraVm>> ConsultarRangoFecha(PlanificacionSiembraVm.ConsultarTodosRangoFecha consultar)
        {
            try
            {
                var respuesta = await _operacionHttp
                    .EjecutarServicioAutenticado<PlanificacionSiembraVm.ConsultarTodosRangoFecha, RespuestaConsultasGenericaVm<PlanificacionSiembraVm>>(
                        _configuration["Microservicios:ConsultarPlanificacionSiembrasFechas"]!, consultar);
