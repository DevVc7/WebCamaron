...
namespace LabCamaronWeb.Servicios.Maestros.Servicios
{
    internal class SeEnteService(IConfiguration configuration, IOperacionHttpServicio operacionHttp) : ISeEnteService
    {
        ...
        public async Task<RespuestaConsultasGenericaVm<EnteVm>> ConsultarTecnicos(ConsultarTodosEnteTecnico consultar)
        {
            try
            {
                var respuesta = await _operacionHttp
                    .EjecutarServicioAutenticado<ConsultarTodosEnteTecnico, RespuestaConsultasGenericaVm<EnteVm>>(
