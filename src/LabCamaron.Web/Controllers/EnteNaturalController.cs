...
{
    public class EnteNaturalController(ISeEnteService seEnteService) : BaseController
    {
        private readonly EnteVm.ConsultarTodosEnte _consultarTodos = new()
        {
            Tipo = ConstantesTipoEntidad.Natural
        };

        [HttpGet]
        [Authorize]
        [AccesosMenu(MenuEnteNatural.CodigoMenu, PermisoGeneral.Ver)]
        public async Task<IActionResult> Index(bool mostrarMensajeExito = false)
        {
            try
            {
                // Se consultan solo los roles activos
                _consultarTodos.Tipo = ConstantesTipoEntidad.Natural;
        ...
        [HttpGet]
        [Authorize]
        [AccesosMenu(MenuEnteNatural.CodigoMenu, MenuEnteNatural.Permisos.Crear)]
        public IActionResult CrearEnte()
        {
            var rolNuevo = new EnteVm() { 
                TipoEntidad = ConstantesTipoEntidad.Natural,
            };
        ...
        [HttpGet]
        [Authorize]
        [AccesosMenu(MenuEnteNatural.CodigoMenu, MenuEnteNatural.Permisos.Editar)]
        ...
        [HttpPost]
        [Authorize]
        [AccesosMenu(MenuEnteNatural.CodigoMenu, MenuEnteNatural.Permisos.Eliminar)]
        ...
        [HttpPost]
        [Authorize]
        [AccesosMenu(MenuEnteNatural.CodigoMenu, MenuEnteNatural.Permisos.Activar)]
